<div class="container py-4 py-lg-5 my-4">
    <div class="row justify-content-center pt-lg-4 text-center">
        <div class="col-lg-5 col-md-7 col-sm-9">
            <h1 class="h2 display-404">404</h1>
    ...
    <div class="row justify-content-center">
        <div class="col-xl-8 col-lg-10">
            <div class="row">
                <div class="col-sm-4 mb-3"><a class="card h-100 border-0 box-shadow-sm" href="../../../index.php">
                        <div class="card-body">
                ...
                <div class="col-sm-4 mb-3"><a class="card h-100 border-0 box-shadow-sm" href="../../../index.php">
                        <div class="card-body">
                            <div class="media align-items-center"><i class="czi-help text-info h4 mb-0"></i>
                                <div class="media-body pl-3">
                                    <h5 class="font-size-sm mb-0">Help &amp; Support</h5><span
                                            class="text-muted font-size-ms">Visit our help center</span>
                                </div>
                            </div>
                        </div>
                    </a></div>
