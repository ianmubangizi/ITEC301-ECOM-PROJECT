...
{
    public $role, $email, $image, $phone, $currency = CURRENCY['ZAR'], $firstname, $lastname, $password;
    ...
    public static function create($firstname, $lastname, $password, $email, $phone = '', $role = CUSTOMER, $image = '', $currency = CURRENCY['ZAR'])
    {
