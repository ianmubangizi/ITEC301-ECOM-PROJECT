...
async function remove_alert() {
    await fetch("functions", {
        method: "POST",
        body: JSON.stringify({function: 'remove_alert'})
    })
        .then((res) => res.json())
